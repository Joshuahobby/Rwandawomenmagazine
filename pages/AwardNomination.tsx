...
const STATIC_CATEGORIES: { INDIVIDUAL: CategoryOption[]; CORPORATE: CategoryOption[]; SME: CategoryOption[] } = {
    INDIVIDUAL: [
        { id: 210, name: 'Women Breaking Barriers in Male-Dominated Sectors', slug: 'women-breaking-barriers-in-male-dominated-sectors', description: 'Women excelling in construction, manufacturing, transport, logistics, ICT hardware, or agri-mechanization.', criteria: 'Leadership, innovation, measurable impact, sector disruption, inspiring others, overcoming barriers.', icon: 'construction', group: 'INDIVIDUAL' },
        { id: 211, name: 'Gender-Transformative Enterprise Award', slug: 'gender-transformative-enterprise-award', description: 'Women-led businesses engaging men to promote equality and transform workplace culture.', criteria: 'Policies promoting equality, male allyship initiatives, staff inclusivity, measurable gender outcomes.', icon: 'diversity_3', group: 'INDIVIDUAL' },
        { id: 3, name: 'Inclusive Innovation for Community Transformation', slug: 'inclusive-innovation-for-community-transformation', description: 'Women-led businesses developing innovative solutions with social impact in underserved communities.', criteria: 'Innovation, scalability, social impact, sustainability, community engagement.', icon: 'lightbulb', group: 'INDIVIDUAL' },
        { id: 4, name: 'Sustainability Trailblazer Award', slug: 'sustainability-trailblazer-award', description: 'Women advancing environmental sustainability, green business, or circular economy.', criteria: 'Environmental impact, innovation, business growth, sustainability integration.', icon: 'eco', group: 'INDIVIDUAL' },
        { id: 6, name: 'Transformational Agripreneur of the Year', slug: 'transformational-agripreneur-of-the-year', description: 'Women transforming agriculture value chains through technology and innovation.', criteria: 'Market impact, adoption of modern practices, economic empowerment of women, sustainability.', icon: 'agriculture', group: 'INDIVIDUAL' },
        { id: 8, name: 'Export Readiness & Market Linkage Champion', slug: 'export-readiness-market-linkage-champion', description: 'Women achieving cross-border trade, regional exports, or strong market linkages.', criteria: 'Market expansion, quality standards, export growth, economic contribution.', icon: 'public', group: 'INDIVIDUAL' },
        { id: 215, name: 'Women-Led Impact Enterprise (High Social ROI)', slug: 'women-led-impact-enterprise-high-social-roi', description: 'Enterprises prioritizing social impact alongside profitability.', criteria: 'Social ROI, measurable outcomes, sustainability, replicability.', icon: 'volunteer_activism', group: 'INDIVIDUAL' },
        { id: 11, name: 'Creative Economy Powerhouse Award', slug: 'creative-economy-powerhouse-award', description: 'Women excelling in fashion, arts, design, media, and entertainment.', criteria: 'Creativity, innovation, brand impact, business growth, sector leadership.', icon: 'palette', group: 'INDIVIDUAL' },
        { id: 220, name: 'Health & Wellness Industry Leadership Award', slug: 'health-wellness-industry-leadership-award', description: 'Women transforming health, wellness, or lifestyle sectors.', criteria: 'Service quality, innovation, community impact, scalability.', icon: 'health_and_safety', group: 'INDIVIDUAL' },
        { id: 222, name: 'Manufacturing & Production Excellence Award', slug: 'manufacturing-production-excellence-award', description: 'Women achieving excellence in production efficiency, quality, and innovation.', criteria: 'Production standards, innovation, business growth, sector leadership.', icon: 'precision_manufacturing', group: 'INDIVIDUAL' },
        { id: 221, name: 'Women in Green & Climate-Smart Business Award', slug: 'women-in-green-climate-smart-business-award', description: 'Women contributing to climate resilience through green solutions.', criteria: 'Environmental impact, innovation, scalability, community or sector influence.', icon: 'forest', group: 'INDIVIDUAL' },
        { id: 15, name: 'Niche Tourism & Experience Curator', slug: 'niche-tourism-experience-curator', description: 'Women creating unique tourism or hospitality experiences showcasing Rwandan heritage.', criteria: 'Creativity, uniqueness, cultural impact, business sustainability.', icon: 'tour', group: 'INDIVIDUAL' },
        { id: 223, name: 'The Employee Wellbeing & Human Capital Advocate', slug: 'the-employee-wellbeing-human-capital-advocate', description: 'Women leaders with exceptional employee mental health and development policies.', criteria: 'Employee policies, wellbeing outcomes, staff development, measurable impact.', icon: 'favorite', group: 'INDIVIDUAL' },
        { id: 17, name: 'Most Gender-Intentionally Designed Product/Service', slug: 'most-gender-intentionally-designed-productservice', description: 'Products or services explicitly designed to address gender-specific needs.', criteria: 'Intentional design, gender impact, innovation, scalability.', icon: 'design_services', group: 'INDIVIDUAL' },
        { id: 18, name: 'Male Champion for Gender Equity', slug: 'male-champion-for-gender-equity', description: 'Male leaders who have actively championed gender equality and women\'s advancement.', criteria: 'Active advocacy, mentorship, measurable impact, public commitment.', icon: 'handshake', group: 'INDIVIDUAL' },
    ],
    CORPORATE: [
        ...
        { id: 22, name: 'Corporate Leader in Gender-Intention Governance', slug: 'corporate-governance', description: 'Embedding inclusive principles within corporate governance frameworks.', criteria: 'Governance frameworks, HR policies, remuneration equity, compliance.', icon: 'gavel', group: 'CORPORATE' },
                    ...
                    <div className="container mx-auto px-4 relative z-10 text-center">
                        ...
                        <p className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
                            ...
                            {nominationStatus === 'open' ? (
                                <> Choose from <span className="text-white font-bold">25 award categories</span> across Individual, Corporate, and SME sectors.</>
                            ) : (
