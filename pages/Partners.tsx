...
const Partners: React.FC<PartnersProps> = ({ navigate }) => {
  return (
    <div className="animate-fade-in font-display">
        <header className="relative w-full h-[600px] flex items-center justify-center overflow-hidden">
             <div className="absolute inset-0 z-0">
                 <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=2000&auto=format&fit=crop" className="w-full h-full object-cover" alt="Partners" />
                     ...
                     <div className="md:w-1/3 bg-background-dark p-10 text-white flex flex-col justify-between">
                         <div>
                             ...
                             <div className="space-y-6 text-sm">
                                 <div className="flex items-center gap-4"><span className="material-icons text-primary">email</span>partners@rwandawomenmag.com</div>
                                 <div className="flex items-center gap-4"><span className="material-icons text-primary">phone</span>+250 788 000 000</div>
                             </div>
                         </div>
                     </div>
