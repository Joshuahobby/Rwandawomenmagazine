            ...
            <div className="container mx-auto px-4 py-3 sm:py-4 relative z-10 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
                <div className="flex-1">
                    <div className="flex items-center justify-center sm:justify-start gap-2 mb-1">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-widest bg-white/20 px-2 py-0.5 rounded">Live Now</span>
                    </div>
                    <p className="font-display font-bold text-lg leading-tight">
                        Voting for RWIBA 2026 is Open!
                    </p>
                    <p className="text-xs text-white/90 hidden sm:block">
                        Support your favorite finalists and celebrate excellence.
                    </p>
                </div>
